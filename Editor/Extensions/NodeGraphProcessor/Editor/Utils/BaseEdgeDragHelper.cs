...
namespace ME.BECS.Extensions.GraphProcessor
{
    ...
    public class BaseEdgeDragHelper : EdgeDragHelper
    {
        ...
        protected Dictionary<BaseNodeView, scg::List<PortView>> compatiblePorts = new Dictionary<BaseNodeView, scg::List<PortView>>();
        ...
        public override bool HandleMouseDown(MouseDownEvent evt)
        {
            ...
            foreach (PortView port in graphView.GetCompatiblePorts(draggedPort, nodeAdapter))
            {
                ...
                if (portList == null)
                    portList = compatiblePorts[port.owner] = new scg::List<PortView>();
                portList.Add(port);
            }
