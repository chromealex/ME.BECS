...
namespace ME.BECS.Extensions.GraphProcessor
{
	...
	public static class NodeProvider
	{
		...
		public class NodeDescriptions
		{
			...
			public scg::List< Type >						slotTypes = new scg::List< Type >();
			public scg::List< PortDescription >			nodeCreatePortDescription = new scg::List<PortDescription>();
		}

		public struct NodeSpecificToGraph
		{
			public Type				nodeType;
			public scg::List<MethodInfo>	isCompatibleWithGraph;
		...
		static scg::List<NodeSpecificToGraph>				specificNodes = new scg::List<NodeSpecificToGraph>();
		...
		static bool IsNodeSpecificToGraph(Type nodeType)
		{
			...
			scg::List<Type> compatibleGraphTypes = nodeMenuAttributes.Where(n => n.onlyCompatibleWithGraph != null).Select(a => a.onlyCompatibleWithGraph).ToList();

			scg::List<MethodInfo> compatibleMethods = new scg::List<MethodInfo>();
