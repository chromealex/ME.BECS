...
namespace ME.BECS.Extensions.GraphProcessor
{
    ...
    public class CreateNodeMenuWindow : ScriptableObject, ISearchWindowProvider
    {
        ...
        public scg::List<SearchTreeEntry> CreateSearchTree(SearchWindowContext context)
        {
            var tree = new scg::List<SearchTreeEntry>
            {
        ...
        void CreateStandardNodeMenu(scg::List<SearchTreeEntry> tree)
        {
        ...
        void CreateEdgeNodeMenu(scg::List<SearchTreeEntry> tree)
        {
