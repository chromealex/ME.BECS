...
namespace ME.BECS.Extensions.GraphProcessor
{
	...
	public class BaseGraphView : GraphView, IDisposable
	{
		...
		/// <returns></returns>
		public scg::List< BaseNodeView >					nodeViews = new scg::List< BaseNodeView >();
		...
		/// <returns></returns>
		public scg::List< EdgeView >						edgeViews = new scg::List< EdgeView >();
		...
		/// <returns></returns>
        public scg::List< GroupView >         			groupViews = new scg::List< GroupView >();
		...
		/// <returns></returns>
		public scg::List< StickyNoteView >				stickyNoteViews = new scg::List<StickyNoteView>();
#endif
		...
		/// <returns></returns>
		public scg::List< BaseStackNodeView >			stackNodeViews = new scg::List< BaseStackNodeView >();
				...
				changes.elementsToRemove.RemoveAll(e => {
					...
					switch (e)
					{
						...
						case BaseNodeView nodeView:
							...
							ExceptionToLog.Call(x => x.OnRemoved(), nodeView);
		...
		public override scg::List< Port > GetCompatiblePorts(Port startPort, NodeAdapter nodeAdapter)
		{
			var compatiblePorts = new scg::List< Port >();
		...
		private void BuildDefaultContextMenu(ContextualMenuPopulateEvent evt) {
		...
		void DragPerformedCallback(DragPerformEvent e)
		{
			...
			var dragData = DragAndDrop.GetGenericData("DragSelection") as scg::List< ISelectable >;

			this.viewTransformChanged?.Invoke(this);
		...
		void ReloadView()
		{
			...
			// Get selected nodes
			var selectedNodeGUIDs = new scg::List<string>();
		...
		protected CreateNodeMenuWindow edgeNode;
		public void CreateNodeRequest(NodeCreationContext context, CreateNodeMenuWindow node) {
		...
		public BaseNodeView AddNode(BaseNode node)
		{
			...
			ExceptionToLog.Call(x => x.OnCreated(), view);
