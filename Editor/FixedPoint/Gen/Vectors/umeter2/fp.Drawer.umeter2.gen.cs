namespace ME.BECS.Editor {
    ...
    [UnityEditor.CustomPropertyDrawer(typeof(umeter2))]
    public class Fpumeter2PropertyDrawer : UnityEditor.PropertyDrawer {
        ...
        public override UnityEngine.UIElements.VisualElement CreatePropertyGUI(UnityEditor.SerializedProperty property) {
            ...
            var propX = property.FindPropertyRelative(nameof(umeter2.x));
            var valueX = propX.uintValue;
            var propY = property.FindPropertyRelative(nameof(umeter2.y));
        ...
        private static void UpdateValues(UnityEditor.SerializedProperty property, FloatField sfX, UnsignedIntegerField siX, FloatField sfY, UnsignedIntegerField siY) {
        ...
        private void UpdateValue(FloatField sfX, UnsignedIntegerField siX, FloatField sfY, UnsignedIntegerField siY) {
