namespace ME.BECS.Editor {
    ...
    [UnityEditor.CustomPropertyDrawer(typeof(meter3))]
    public class Fpmeter3PropertyDrawer : UnityEditor.PropertyDrawer {
        ...
        public override UnityEngine.UIElements.VisualElement CreatePropertyGUI(UnityEditor.SerializedProperty property) {
            ...
            var propX = property.FindPropertyRelative(nameof(meter3.x));
            var valueX = propX.intValue;
            var propY = property.FindPropertyRelative(nameof(meter3.y));
            var valueY = propY.intValue;
            var propZ = property.FindPropertyRelative(nameof(meter3.z));
        ...
        private static void UpdateValues(UnityEditor.SerializedProperty property, FloatField sfX, IntegerField siX, FloatField sfY, IntegerField siY, FloatField sfZ, IntegerField siZ) {
        ...
        private void UpdateValue(FloatField sfX, IntegerField siX, FloatField sfY, IntegerField siY, FloatField sfZ, IntegerField siZ) {
