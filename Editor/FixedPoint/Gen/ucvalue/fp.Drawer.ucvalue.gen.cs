namespace ME.BECS.Editor {
    ...
    [UnityEditor.CustomPropertyDrawer(typeof(ucvalue))]
    public class FpucvaluePropertyDrawer : UnityEditor.PropertyDrawer {

        private int type;

        public string customName;
        public System.Func<uint, uint> onValueSet;
        public System.Func<ucvalue, ucvalue> onValueChanged;
        ...
        public override UnityEngine.UIElements.VisualElement CreatePropertyGUI(UnityEditor.SerializedProperty property) {
            ...
            var prop = property.FindPropertyRelative(nameof(ucvalue.value));
            ...
            container.Add(si);
            {
                this.UpdateValue(sf, si);
                {
                    sf.RegisterCallback<ChangeEvent<float>>((evt) => {
                        ...
                        var orig = ucvalue.FromFloat(val);
            ...
            this.UpdateValues(property, sf, si);
            var items = new System.Collections.Generic.List<string>() { "0..1", "0..1000" };
        ...
        private void UpdateValues(UnityEditor.SerializedProperty property, FloatField sf, UnsignedIntegerField si) {
            ...
            sf.SetValueWithoutNotify(new ucvalue(value).ToFloat());
