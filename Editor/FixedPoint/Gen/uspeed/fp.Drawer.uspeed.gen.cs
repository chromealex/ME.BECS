namespace ME.BECS.Editor {
    ...
    [UnityEditor.CustomPropertyDrawer(typeof(uspeed))]
    public class FpuspeedPropertyDrawer : UnityEditor.PropertyDrawer {

        private int type;

        public string customName;
        public System.Func<uint, uint> onValueSet;
        public System.Func<uspeed, uspeed> onValueChanged;
        ...
        public override UnityEngine.UIElements.VisualElement CreatePropertyGUI(UnityEditor.SerializedProperty property) {
            ...
            var prop = property.FindPropertyRelative(nameof(uspeed.value));
            ...
            this.UpdateValues(property, sf, si);
            var items = new System.Collections.Generic.List<string>() { "m\u200A\u2215\u200Bs", "original" };
        ...
        private void UpdateValues(UnityEditor.SerializedProperty property, FloatField sf, UnsignedIntegerField si) {
            ...
            sf.SetValueWithoutNotify(new uspeed(value).ToFloat());
