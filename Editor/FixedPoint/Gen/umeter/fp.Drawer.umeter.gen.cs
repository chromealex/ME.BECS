namespace ME.BECS.Editor {
    ...
    [UnityEditor.CustomPropertyDrawer(typeof(umeter))]
    public class FpumeterPropertyDrawer : UnityEditor.PropertyDrawer {

        private int type;

        public string customName;
        public System.Func<uint, uint> onValueSet;
        public System.Func<umeter, umeter> onValueChanged;
        ...
        private void UpdateValues(UnityEditor.SerializedProperty property, FloatField sf, UnsignedIntegerField si) {
            ...
            sf.SetValueWithoutNotify(new umeter(value).ToFloat());
