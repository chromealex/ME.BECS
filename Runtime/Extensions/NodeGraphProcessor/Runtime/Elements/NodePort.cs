...
namespace ME.BECS.Extensions.GraphProcessor
{
	...
	public class NodePort
	{
		...
		scg::List< SerializableEdge >	edges = new scg::List< SerializableEdge >();
		Dictionary< SerializableEdge, PushDataDelegate >	pushDataDelegates = new Dictionary< SerializableEdge, PushDataDelegate >();
		scg::List< SerializableEdge >	edgeWithRemoteCustomIO = new scg::List< SerializableEdge >();
...
// We keep slow checks inside the editor
		...
		/// </summary>
		/// <returns></returns>
		public scg::List< SerializableEdge > GetEdges() => edges;
	...
	/// </summary>
	public abstract class NodePortContainer : scg::List< NodePort >
	{
