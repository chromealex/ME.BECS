namespace ME.BECS.Jobs {
    ...
    public static unsafe partial class QueryParallelAspectsComponentsScheduleExtensions {
        ...
        public static JobHandle Schedule<T, A0, C0,C1>(this QueryBuilder builder, in T job = default) where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> where A0 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            builder.WithAspect<A0>();
            builder.With<C0>(); builder.With<C1>();
            builder.builderDependsOn = builder.SetEntities(builder.commandBuffer, builder.builderDependsOn);
            builder.builderDependsOn = job.Schedule<T, A0, C0,C1>(in builder.commandBuffer, builder.parallelForBatch, builder.isUnsafe, builder.builderDependsOn);
            builder.builderDependsOn = builder.Dispose(builder.builderDependsOn);
            return builder.builderDependsOn;
        }
        
        public static JobHandle Schedule<T, A0, C0,C1>(this Query staticQuery, in T job, in SystemContext context) where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> where A0 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            return staticQuery.Schedule<T, A0, C0,C1>(in job, in context.world, context.dependsOn);
        }
        
        public static JobHandle Schedule<T, A0, C0,C1>(this Query staticQuery, in T job, in World world, JobHandle dependsOn = default) where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> where A0 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            var state = world.state;
            var query = API.MakeStaticQuery(QueryContext.Create(state, world.id), dependsOn).FromQueryData(state, world.id, state->queries.GetPtr(state, staticQuery.id));
            return query.Schedule<T, A0, C0,C1>(in job);
        }

        public static JobHandle Schedule<T, A0, C0,C1>(this QueryBuilderDisposable staticQuery, in T job) where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> where A0 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            staticQuery.builderDependsOn = job.Schedule<T, A0, C0,C1>(in staticQuery.commandBuffer, staticQuery.parallelForBatch, staticQuery.isUnsafe, staticQuery.builderDependsOn);
    ...
    public static partial class EarlyInit {
        public static void DoParallelForAspectsComponents<T, A0, C0,C1>()
                where A0 : unmanaged, IAspect
                where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
                where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> => JobParallelForAspectsComponentsExtensions.JobEarlyInitialize<T, A0, C0,C1>();
    }

    [JobProducerType(typeof(JobParallelForAspectsComponentsExtensions.JobProcess<,,,>))]
    public interface IJobParallelForAspectsComponents<A0, C0,C1> : IJobParallelForAspectsComponentsBase where A0 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
    ...
    public static unsafe partial class JobParallelForAspectsComponentsExtensions {
        ...
        public static void JobEarlyInitialize<T, A0, C0,C1>()
            where A0 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
            where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> => JobProcess<T, A0, C0,C1>.Initialize();

        private static System.IntPtr GetReflectionData<T, A0, C0,C1>()
            where A0 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
            where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> {
        ...
        public static JobHandle Schedule<T, A0, C0,C1>(this T jobData, in CommandBuffer* buffer, uint innerLoopBatchCount, bool unsafeMode, JobHandle dependsOn = default)
            where A0 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
            where T : struct, IJobParallelForAspectsComponents<A0, C0,C1> {
            ...
            var parameters = new JobsUtility.JobScheduleParameters(data, unsafeMode == true ? GetReflectionUnsafeData<T, A0, C0,C1>() : GetReflectionData<T, A0, C0,C1>(), dependsOn, ScheduleMode.Parallel);
            #else
            ...
            var parameters = new JobsUtility.JobScheduleParameters(data, GetReflectionData<T, A0, C0,C1>(), dependsOn, ScheduleMode.Parallel);
            #endif
