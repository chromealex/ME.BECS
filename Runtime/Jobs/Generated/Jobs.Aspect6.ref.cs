namespace ME.BECS.Jobs {
    ...
    public static unsafe partial class QueryAspectScheduleExtensions {
        ...
        public static JobHandle Schedule<T, T0,T1,T2,T3,T4,T5>(this QueryBuilder builder, in T job = default) where T : struct, IJobAspect<T0,T1,T2,T3,T4,T5> where T0 : unmanaged, IAspect where T1 : unmanaged, IAspect where T2 : unmanaged, IAspect where T3 : unmanaged, IAspect where T4 : unmanaged, IAspect where T5 : unmanaged, IAspect {
    ...
    public static partial class EarlyInit {
        public static void DoAspect<T, T0,T1,T2,T3,T4,T5>()
                ...
                where T : struct, IJobAspect<T0,T1,T2,T3,T4,T5> => JobAspectExtensions.JobEarlyInitialize<T, T0,T1,T2,T3,T4,T5>();
    }

    [JobProducerType(typeof(JobAspectExtensions.JobProcess<,,,,,,>))]
    public interface IJobAspect<T0,T1,T2,T3,T4,T5> : IJobAspectBase where T0 : unmanaged, IAspect where T1 : unmanaged, IAspect where T2 : unmanaged, IAspect where T3 : unmanaged, IAspect where T4 : unmanaged, IAspect where T5 : unmanaged, IAspect {
    ...
    public static unsafe partial class JobAspectExtensions {
        ...
        public static void JobEarlyInitialize<T, T0,T1,T2,T3,T4,T5>()
            where T0 : unmanaged, IAspect where T1 : unmanaged, IAspect where T2 : unmanaged, IAspect where T3 : unmanaged, IAspect where T4 : unmanaged, IAspect where T5 : unmanaged, IAspect
            where T : struct, IJobAspect<T0,T1,T2,T3,T4,T5> => JobProcess<T, T0,T1,T2,T3,T4,T5>.Initialize();

        private static System.IntPtr GetReflectionData<T, T0,T1,T2,T3,T4,T5>() where T0 : unmanaged, IAspect where T1 : unmanaged, IAspect where T2 : unmanaged, IAspect where T3 : unmanaged, IAspect where T4 : unmanaged, IAspect where T5 : unmanaged, IAspect where T : struct, IJobAspect<T0,T1,T2,T3,T4,T5> {
        ...
        private static System.IntPtr GetReflectionUnsafeData<T, T0,T1,T2,T3,T4,T5>() where T0 : unmanaged, IAspect where T1 : unmanaged, IAspect where T2 : unmanaged, IAspect where T3 : unmanaged, IAspect where T4 : unmanaged, IAspect where T5 : unmanaged, IAspect where T : struct, IJobAspect<T0,T1,T2,T3,T4,T5> {
            JobProcess<T, T0,T1,T2,T3,T4,T5>.Initialize();
