namespace ME.BECS.Jobs {
    ...
    public static unsafe partial class JobAspectExtensions {
        ...
        private static System.IntPtr GetReflectionData<T, T0>() where T0 : unmanaged, IAspect where T : struct, IJobAspect<T0> {
        ...
        private static System.IntPtr GetReflectionUnsafeData<T, T0>() where T0 : unmanaged, IAspect where T : struct, IJobAspect<T0> {
            JobProcess<T, T0>.Initialize();
