namespace ME.BECS.Jobs {
    ...
    public static unsafe partial class JobParallelForAspectExtensions {
        ...
        private static System.IntPtr GetReflectionUnsafeData<T, T0,T1,T2,T3>() where T0 : unmanaged, IAspect where T1 : unmanaged, IAspect where T2 : unmanaged, IAspect where T3 : unmanaged, IAspect where T : struct, IJobParallelForAspect<T0,T1,T2,T3> {
            JobProcess<T, T0,T1,T2,T3>.Initialize();
