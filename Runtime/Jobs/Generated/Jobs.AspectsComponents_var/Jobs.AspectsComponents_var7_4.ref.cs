namespace ME.BECS.Jobs {
    ...
    public static unsafe partial class QueryAspectsComponentsScheduleExtensions7_4 {
        ...
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1,C2,C3>(this QueryBuilder builder, in T job = default) where T : struct, IJobFor7Aspects4Components<A0,A1,A2,A3,A4,A5,A6, C0,C1,C2,C3> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase {
            ...
            builder.builderDependsOn = job.Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1,C2,C3>(in builder.commandBuffer.ptr, builder.isUnsafe, builder.parallelForBatch, builder.scheduleMode, builder.builderDependsOn);
        ...
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1,C2,C3>(this QueryBuilderDisposable staticQuery, in T job) where T : struct, IJobFor7Aspects4Components<A0,A1,A2,A3,A4,A5,A6, C0,C1,C2,C3> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase {
            staticQuery.builderDependsOn = job.Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1,C2,C3>(in staticQuery.commandBuffer.ptr, staticQuery.isUnsafe, staticQuery.parallelForBatch, staticQuery.scheduleMode, staticQuery.builderDependsOn);
