namespace ME.BECS.Jobs {
    ...
    public static unsafe partial class QueryAspectsComponentsScheduleExtensions {
        ...
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(this QueryBuilder builder, in T job = default) where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase {
            ...
            builder.builderDependsOn = job.Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(in builder.commandBuffer, builder.isUnsafe, builder.builderDependsOn);
            builder.builderDependsOn = builder.Dispose(builder.builderDependsOn);
            return builder.builderDependsOn;
        }
        
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(this Query staticQuery, in T job, in SystemContext context) where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase {
            return staticQuery.Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(in job, in context.world, context.dependsOn);
        }
        
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(this Query staticQuery, in T job, in World world, JobHandle dependsOn = default) where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase {
            var state = world.state;
            var query = API.MakeStaticQuery(QueryContext.Create(state, world.id), dependsOn).FromQueryData(state, world.id, state->queries.GetPtr(state, staticQuery.id));
            return query.Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(in job);
        }

        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(this QueryBuilderDisposable staticQuery, in T job) where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase {
            staticQuery.builderDependsOn = job.Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(in staticQuery.commandBuffer, staticQuery.isUnsafe, staticQuery.builderDependsOn);
    ...
    public static partial class EarlyInit {
        public static void DoAspectsComponents<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>()
                ...
                where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> => JobAspectsComponentsExtensions.JobEarlyInitialize<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>();
    }

    [JobProducerType(typeof(JobAspectsComponentsExtensions.JobProcess<,,,,,,,,,,>))]
    public interface IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> : IJobForAspectsComponentsBase where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase {
    ...
    public static unsafe partial class JobAspectsComponentsExtensions {
        ...
        public static void JobEarlyInitialize<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>()
            where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase
            where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> => JobProcess<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>.Initialize();

        private static System.IntPtr GetReflectionData<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>()
            where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase
            where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> {
        ...
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(this T jobData, in CommandBuffer* buffer, bool unsafeMode, JobHandle dependsOn = default)
            where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase where C2 : unmanaged, IComponentBase where C3 : unmanaged, IComponentBase
            where T : struct, IJobForAspectsComponents<A0,A1,A2,A3,A4,A5, C0,C1,C2,C3> {
            ...
            var parameters = new JobsUtility.JobScheduleParameters(data, unsafeMode == true ? GetReflectionUnsafeData<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>() : GetReflectionData<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(), dependsOn, ScheduleMode.Single);
            #else
            ...
            var parameters = new JobsUtility.JobScheduleParameters(data, GetReflectionData<T, A0,A1,A2,A3,A4,A5, C0,C1,C2,C3>(), dependsOn, ScheduleMode.Single);
            #endif
