namespace ME.BECS.Jobs {
    ...
    [JobProducerType(typeof(JobAspectsComponentsExtensions7_2.JobProcess<,,,,,,,,,>))]
    public interface IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> : IJobForAspectsComponentsBase where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
        void Execute(in JobInfo jobInfo, in Ent ent, ref A0 a0,ref A1 a1,ref A2 a2,ref A3 a3,ref A4 a4,ref A5 a5,ref A6 a6, ref C0 c0,ref C1 c1);
    }

    public static unsafe partial class QueryAspectsComponentsScheduleExtensions7_2 {
        
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(this QueryBuilder builder, in T job = default) where T : struct, IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            ...
            builder.builderDependsOn = job.Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(in builder.commandBuffer, builder.isUnsafe, builder.parallelForBatch, builder.scheduleMode, builder.builderDependsOn);
            builder.builderDependsOn = builder.Dispose(builder.builderDependsOn);
            return builder.builderDependsOn;
        }
        
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(this Query staticQuery, in T job, in SystemContext context) where T : struct, IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            return staticQuery.Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(in job, in context.world, context.dependsOn);
        }
        
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(this Query staticQuery, in T job, in World world, JobHandle dependsOn = default) where T : struct, IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            var state = world.state;
            var query = API.MakeStaticQuery(QueryContext.Create(state, world.id), dependsOn).FromQueryData(state, world.id, state->queries.GetPtr(state, staticQuery.id));
            return query.Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(in job);
        }
        ...
        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(this QueryBuilderDisposable staticQuery, in T job) where T : struct, IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase {
            staticQuery.builderDependsOn = job.Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(in staticQuery.commandBuffer, staticQuery.isUnsafe, staticQuery.parallelForBatch, staticQuery.scheduleMode, staticQuery.builderDependsOn);
    ...
    public static partial class EarlyInit {
        public static void DoAspectsComponents7_2<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>()
                ...
                where T : struct, IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> => JobAspectsComponentsExtensions7_2.JobEarlyInitialize<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>();
    }

    public static unsafe partial class JobAspectsComponentsExtensions7_2 {
        
        public static void JobEarlyInitialize<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>()
            where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
            where T : struct, IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> => JobProcess<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>.Initialize();

        public static JobHandle Schedule<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>(this T jobData, in CommandBuffer* buffer, bool unsafeMode, uint innerLoopBatchCount, ScheduleMode scheduleMode, JobHandle dependsOn = default)
            where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
        ...
        private struct JobData<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>
            where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
            where T : struct {
        ...
        internal struct JobProcess<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>
            where A0 : unmanaged, IAspect where A1 : unmanaged, IAspect where A2 : unmanaged, IAspect where A3 : unmanaged, IAspect where A4 : unmanaged, IAspect where A5 : unmanaged, IAspect where A6 : unmanaged, IAspect
            where C0 : unmanaged, IComponentBase where C1 : unmanaged, IComponentBase
            where T : struct, IJobFor7Aspects2Components<A0,A1,A2,A3,A4,A5,A6, C0,C1> {
            ...
            public static void Initialize() {
                if (JobReflectionData<T>.data.Data == System.IntPtr.Zero) {
                    ...
                    #else
                    JobReflectionData<T>.data.Data = JobsUtility.CreateJobReflectionData(typeof(JobData<T, A0,A1,A2,A3,A4,A5,A6, C0,C1>), typeof(T), (ExecuteJobFunction)Execute);
                    #endif
                }
            }

            private delegate void ExecuteJobFunction(ref JobData<T, A0,A1,A2,A3,A4,A5,A6, C0,C1> jobData, System.IntPtr bufferPtr, System.IntPtr bufferRangePatchData, ref JobRanges ranges, int jobIndex);
