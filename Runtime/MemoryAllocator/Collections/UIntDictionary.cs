namespace ME.BECS {
    ...
    public unsafe struct UIntDictionary<TValue> where TValue : unmanaged {
        ...
        public struct Enumerator {
            ...
            internal Enumerator(in UIntDictionary<TValue> dictionary, SafePtr<State> state) {
        ...
        public void CopyFrom(ref MemoryAllocator allocator, in UIntDictionary<TValue> other) {
            ...
            if (this.GetMemPtr().IsValid() == false) this = new UIntDictionary<TValue>(ref allocator, other.Count);
        ...
        public readonly ref TValue this[in MemoryAllocator allocator, uint key] {
            [INLINE(256)]
            get {
        ...
        [INLINE(256)]
        public ref TValue ReadValue(SafePtr<State> state, uint key) {
        ...
        public TValue GetValueAndRemove(in MemoryAllocator allocator, uint key, TValue defaultValue = default) {
            ...
            if (this.Remove(in allocator, key, out var value) == false) return defaultValue;
            return value;
        ...
        public TValue GetValueAndRemove(in MemoryAllocator allocator, uint key, out bool removed) {
            ...
            removed = false;
            if (this.Remove(in allocator, key, out var value) == true) {
                removed = true;
            }
            return value;
        ...
        [INLINE(256)]
        public void Add(ref MemoryAllocator allocator, uint key, TValue value) {
        ...
        [INLINE(256)]
        public readonly bool ContainsKey(in MemoryAllocator allocator, uint key) {
        ...
        [INLINE(256)]
        private readonly int FindEntry(in MemoryAllocator allocator, uint key) {
            var index = -1;
            var num1 = 0;
        ...
        [INLINE(256)]
        public bool Remove(in MemoryAllocator allocator, uint key) {
        ...
        /// <param name="value"></param>
        [INLINE(256)]
        public bool Remove(in MemoryAllocator allocator, uint key, out TValue value) {
        ...
        /// <param name="value"></param>
        [INLINE(256)]
        public readonly bool TryGetValue(in MemoryAllocator allocator, uint key, out TValue value) {
