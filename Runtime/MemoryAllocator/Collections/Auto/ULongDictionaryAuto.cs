namespace ME.BECS {
    ...
    [System.Diagnostics.DebuggerTypeProxyAttribute(typeof(ULongDictionaryAutoProxy<>))]
    public unsafe struct ULongDictionaryAuto<TValue> : IIsCreated where TValue : unmanaged {
        ...
        public struct Enumerator {
            ...
            [INLINE(256)]
            internal Enumerator(in ULongDictionaryAuto<TValue> dictionary, SafePtr<State> state) {
        ...
        [INLINE(256)]
        public ULongDictionaryAuto(in Ent ent, uint capacity) {
        ...
        [INLINE(256)]
        public void ReplaceWith(in ULongDictionaryAuto<TValue> other) {
        ...
        [INLINE(256)]
        public void CopyFrom(in ULongDictionaryAuto<TValue> other) {
        ...
        [INLINE(256)]
        public ref TValue GetValue(ulong key) {
        ...
        [INLINE(256)]
        public ref TValue GetValue(ulong key, out bool exist) {
        ...
        [INLINE(256)]
        public TValue GetValueAndRemove(ulong key) {
        ...
        private readonly int FindEntry(ulong key) {
            ...
            if (this.buckets.Length > 0u) {
                ...
                var entries = (SafePtr<Entry>)this.entries.GetUnsafePtrCached();
        ...
        private bool TryInsert(in Ent ent, ulong key, TValue value, InsertionBehavior behavior) {
            ...
            var entries = (SafePtr<Entry>)this.entries.GetUnsafePtrCached(in state.ptr->allocator);
            ...
            if (this.freeCount > 0) {
                ...
                index2 = count;
                this.count = count + 1;
                entries = (SafePtr<Entry>)this.entries.GetUnsafePtrCached(in state.ptr->allocator);
            }
