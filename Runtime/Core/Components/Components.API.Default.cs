namespace ME.BECS {
    ...
    public unsafe partial struct Components {
        ...
        [INLINE(256)]
        public static bool IsEnabled<T>(SafePtr<State> state, in Ent ent) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static bool Enable<T>(SafePtr<State> state, in Ent ent) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static bool Disable<T>(SafePtr<State> state, in Ent ent) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static bool Set<T>(SafePtr<State> state, in Ent ent, in T data) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static bool Remove<T>(SafePtr<State> state, in Ent ent) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static bool Remove(SafePtr<State> state, in Ent ent, uint typeId, uint groupId) {
        ...
        [INLINE(256)]
        public static ref readonly T Read<T>(SafePtr<State> state, uint entId, ushort gen, out bool exists) where T : unmanaged, IComponentBase {
        ...
        [INLINE(256)]
        public static ref readonly T Read<T>(SafePtr<State> state, uint entId, ushort gen) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static T* ReadPtr<T>(SafePtr<State> state, uint entId, ushort gen, out bool exists) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static T* ReadPtr<T>(SafePtr<State> state, uint entId, ushort gen) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static bool Has<T>(SafePtr<State> state, uint entId, ushort gen, bool checkEnabled) where T : unmanaged, IComponentBase {
        ...
        [INLINE(256)]
        public static ref T Get<T>(SafePtr<State> state, in Ent ent) where T : unmanaged, IComponent => ref Get<T>(state, ent);

        [INLINE(256)]
        public static ref T Get<T>(SafePtr<State> state, Ent ent) where T : unmanaged, IComponent {
        ...
        [INLINE(256)]
        public static T* Get<T>(SafePtr<State> state, in Ent ent, out bool isNew) where T : unmanaged, IComponent {
