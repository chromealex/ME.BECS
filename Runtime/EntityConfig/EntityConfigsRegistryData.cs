...
namespace ME.BECS {
    ...
    public class EntityConfigsRegistryData : UnityEngine.ScriptableObject {

        [System.Serializable]
        public struct Item {

            public EntityConfig source;
        ...
        public EntityConfig GetEntityConfigBySourceId(uint sourceId) {
        ...
        public uint Add(EntityConfig source, out bool isNew) {
        ...
        public bool Remove(EntityConfig source) {
