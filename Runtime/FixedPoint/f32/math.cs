...
namespace ME.BECS {
    ...
    public static partial class mathext {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Unity.Mathematics.float3 normalizesafe(Unity.Mathematics.float3 x, Unity.Mathematics.float3 y, out float distance,
                                                             Unity.Mathematics.float3 defaultvalue = new()) {
            var dir = x - y;
    ...
    public static partial class mathext {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ME.BECS.FixedPoint.float3 normalizesafe(ME.BECS.FixedPoint.float3 x, ME.BECS.FixedPoint.float3 y, out sfloat distance,
                                                              ME.BECS.FixedPoint.float3 defaultvalue = new()) {
            var dir = x - y;
    ...
    public static class quaternionext {
        ...
        public static Unity.Mathematics.quaternion FromToRotation(Unity.Mathematics.float3 from, Unity.Mathematics.float3 to) {
            return Unity.Mathematics.quaternion.AxisAngle(
                angle: Unity.Mathematics.math.acos(
                    Unity.Mathematics.math.clamp(Unity.Mathematics.math.dot(Unity.Mathematics.math.normalize(from), Unity.Mathematics.math.normalize(to)), -1f, 1f)),
        ...
        public static ME.BECS.FixedPoint.quaternion FromToRotation(ME.BECS.FixedPoint.float3 from, ME.BECS.FixedPoint.float3 to) {
            return ME.BECS.FixedPoint.quaternion.AxisAngle(
                angle: ME.BECS.FixedPoint.math.acos(
                    ME.BECS.FixedPoint.math.clamp(ME.BECS.FixedPoint.math.dot(ME.BECS.FixedPoint.math.normalize(from), ME.BECS.FixedPoint.math.normalize(to)), -1f, 1f)),
...
namespace ME.BECS.FixedPoint {
    ...
    public static partial class math {
        ...
        public static sfloat angle(float3 from, float3 to) {
            ...
            return (double)num < 1.0000000036274937E-15 ? 0.0f : acos(clamp(dot(from, to) / num, -1f, 1f)) * 57.29578f;
        }
        ...
        public static bool2 isnan(float2 x) {
            return bool2(x.x.IsNaN(), x.y.IsNaN());
        }
        ...
        public static bool3 isnan(float3 x) {
            return bool3(x.x.IsNaN(), x.y.IsNaN(), x.z.IsNaN());
        }
        ...
        public static bool4 isnan(float4 x) {
            return bool4(x.x.IsNaN(), x.y.IsNaN(), x.z.IsNaN(), x.w.IsNaN());
        }
