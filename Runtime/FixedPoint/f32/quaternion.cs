...
namespace ME.BECS.FixedPoint {
    ...
    public partial struct quaternion : System.IEquatable<quaternion>, IFormattable {
        ...
        public static quaternion identity => new(sfloat.Zero, sfloat.Zero, sfloat.Zero, sfloat.One);
        ...
        public quaternion(float3x3 m) {
            ...
            static quaternion quat(int index, sfloat t, sfloat a, sfloat b, sfloat c) {
                var s = 0.5f / sqrt(t);
                return index switch {
                    3 => new quaternion(a * s, b * s, c * s, t * s),
                    2 => new quaternion(a * s, b * s, t * s, c * s),
                    1 => new quaternion(a * s, t * s, b * s, c * s),
                    _ => new quaternion(t * s, a * s, b * s, c * s),
                };
            }
        }
        ...
        public static quaternion AxisAngle(float3 axis, sfloat angle) {
            sfloat sina, cosa;
            sincos((sfloat)0.5f * angle, out sina, out cosa);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerXYZ(sfloat x, sfloat y, sfloat z) {
        ...
        /// <param name="z">The rotation angle around the z-axis in radians.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerXZY(sfloat x, sfloat y, sfloat z) {
        ...
        /// <param name="z">The rotation angle around the z-axis in radians.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerYXZ(sfloat x, sfloat y, sfloat z) {
        ...
        /// <param name="z">The rotation angle around the z-axis in radians.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerYZX(sfloat x, sfloat y, sfloat z) {
        ...
        /// <param name="z">The rotation angle around the z-axis in radians.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerZXY(sfloat x, sfloat y, sfloat z) {
        ...
        /// <param name="z">The rotation angle around the z-axis in radians.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion EulerZYX(sfloat x, sfloat y, sfloat z) {
        ...
        public override bool Equals(object x) {
            return this.Equals((quaternion)x);
        }
        ...
        public override string ToString() {
            return string.Format("quaternion({0}f, {1}f, {2}f, {3}f)", this.value.x, this.value.y, this.value.z, this.value.w);
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider) {
            return string.Format("quaternion({0}f, {1}f, {2}f, {3}f)", this.value.x.ToString(format, formatProvider), this.value.y.ToString(format, formatProvider),
                                 this.value.z.ToString(format, formatProvider), this.value.w.ToString(format, formatProvider));
        }
    ...
    public static partial class math {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion quaternion(sfloat x, sfloat y, sfloat z, sfloat w) {
        ...
        public static quaternion normalizesafe(quaternion q) {
            var x = q.value;
            var len = dot(x, x);
            return quaternion(select(FixedPoint.quaternion.identity.value, x * rsqrt(len), len > FLT_MIN_NORMAL));
        }
        ...
        public static quaternion unitlog(quaternion q) {
            var w = clamp(q.value.w, -sfloat.One, sfloat.One);
            var s = acos(w) * rsqrt(sfloat.One - w * w);
        ...
        public static quaternion log(quaternion q) {
            ...
            var s = acos(clamp(q.value.w * rsqrt(q_len_sq), -sfloat.One, sfloat.One)) * rsqrt(v_len_sq);
        ...
        public static quaternion mul(quaternion a, quaternion b) {
            return quaternion(a.value.wwww * b.value + (a.value.xyzx * b.value.wwwx + a.value.yzxy * b.value.zxyy) * float4(sfloat.One, sfloat.One, sfloat.One, -sfloat.One) -
        ...
        public static float3 mul(quaternion q, float3 v) {
            var t = (sfloat)2.0f * cross(q.value.xyz, v);
        ...
        public static quaternion slerp(quaternion q1, quaternion q2, sfloat t) {
            ...
            if (dt < FixMath.ALMOST_ONE) {
                var angle = acos(dt);
                var s = rsqrt(sfloat.One - dt * dt); // 1.0f / sin(angle)
                var w1 = sin(angle * (sfloat.One - t)) * s;
        ...
        public static float3 forward(quaternion q) {
            return mul(q, float3(sfloat.Zero, sfloat.Zero, sfloat.One));
        } // for compatibility
