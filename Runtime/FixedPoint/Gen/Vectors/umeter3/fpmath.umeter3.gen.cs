namespace ME.BECS {
    ...
    public static partial class fpmath {
        ...
        /// <summary>Returns the absolute value of a umeter3 value.</summary>
        /// <param name="x">Input value.</param>
        /// <returns>The absolute value of the input.</returns>
        [INLINE(256)]
        public static umeter3 abs(umeter3 x) { return new umeter3(um::math.max(0u, x.x.value), um::math.max(0u, x.y.value), um::math.max(0u, x.z.value)); }

        /// <summary>Returns the result of clamping the value valueToClamp into the interval (inclusive) [lowerBound, upperBound], where valueToClamp, lowerBound and upperBound are umeter3 values.</summary>
        ...
        [INLINE(256)]
        public static umeter3 clamp(umeter3 valueToClamp, umeter3 lowerBound, umeter3 upperBound) { return new umeter3(um::math.max(lowerBound.x.value, um::math.min(upperBound.x.value, valueToClamp.x.value)),
        ...
        [INLINE(256)]
        public static umeter3 lerp(umeter3 start, umeter3 end, ucvalue t) { return start + t * (end - start); }
        
        [INLINE(256)]
        public static umeter3 sqrt(umeter3 value) {
            return new umeter3(fpmath.sqrt(value.x).value, fpmath.sqrt(value.y).value, fpmath.sqrt(value.z).value);
        }
