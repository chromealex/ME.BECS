...
namespace ME.BECS {
    ...
    public static class mathext {
        ...
        public static sfloat angle(ME.BECS.FixedPoint.float3 from, ME.BECS.FixedPoint.float3 to) {
            ...
            return (double)num < 1.0000000036274937E-15 ? 0.0f : ME.BECS.FixedPoint.math.acos(ME.BECS.FixedPoint.math.clamp(ME.BECS.FixedPoint.math.dot(from, to) / num, -1f, 1f)) * 57.29578f;
        }
...
namespace ME.BECS.FixedPoint {
    ...
    public static partial class math {
        ...
        /// <summary>Returns the minimum of two long values.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static long min(int x, uint y) { return x < y ? x : y; }
