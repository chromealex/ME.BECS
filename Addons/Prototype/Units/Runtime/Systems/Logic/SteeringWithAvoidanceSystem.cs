...
namespace ME.BECS.Units {
    ...
    public struct SteeringWithAvoidanceSystem : IUpdate, IDrawGizmos {
        ...
        public void OnUpdate(ref SystemContext context) {
            ...
            var dependsOnSpatial = context.Query().AsParallel().Without<IsUnitStaticComponent>().Without<UnitHoldComponent>().Schedule<SpatialJob, TransformAspect, UnitAspect, SpatialQueryAspect>(new SpatialJob() {
                world = context.world,
                system = this,
                dt = context.deltaTime,
            });
