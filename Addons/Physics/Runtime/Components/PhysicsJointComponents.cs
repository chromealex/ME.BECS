...
namespace ME.BECS.Physics.Components
{
    ...
    public struct PhysicsConstrainedBodyPair : IComponent
    {
        ...
        [CreateProperty]
        public Ent EntityA => Entities.EntityA;

        /// <summary>   The second entity in the pair. </summary>
        ///
        /// <value> The entity b. </value>
        [CreateProperty]
        public Ent EntityB => Entities.EntityB;
        ...
        public PhysicsConstrainedBodyPair(Ent entityA, Ent entityB, bool enableCollision)
        {
