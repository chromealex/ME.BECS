...
namespace NativeTrees
{
    ...
    public static class NativeOctreeExtensions
    {
        ...
        /// </summary>
        public static bool RaycastAABB<T>(this NativeOctree<T> octree, Ray ray, out OctreeRaycastHit<T> hit, float maxDistance = float.PositiveInfinity) where T : unmanaged, IComparable<T>
        {
        ...
        public static bool TryGetNearestAABB<T>(this NativeOctree<T> octree, float3 point, float maxDistance, out T nearest) where T : unmanaged, IComparable<T>
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns>If an object was found within the given maximum distance</returns>
        public static bool TryGetNearestAABB<T>(this NativeOctree<T>.NearestNeighbourCache queryCache, ref NativeOctree<T> octree, float3 point, float maxDistance, out T nearest) where T : unmanaged, IComparable<T>
        {
            var visitor = new OctreeNearestAABBVisitor<T>();
