...
namespace NativeTrees
{
    ...
    public partial struct NativeQuadtree<T> : INativeDisposable where T : unmanaged 
    {
        ...
        /// </summary>
        public UnsafeParallelHashMap<uint, int> nodes;
        ...
        public NativeQuadtree(AABB2D bounds, int objectsPerNode, int maxDepth, Allocator allocator, int initialCapacity = 0)
        {
            ...
            objects = new UnsafeParallelMultiHashMap<uint, ObjWrapper>(initialCapacity, allocator);
            nodes = new UnsafeParallelHashMap<uint, int>(initialCapacity / objectsPerNode, allocator);
