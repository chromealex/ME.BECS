namespace ME.BECS {
    ...
    public partial struct Query {
        ...
        [INLINE(256)]
        public static QueryBuilderStatic WithAll<T0, T1>(in SystemContext systemContext) where T0 : unmanaged, IComponent where T1 : unmanaged, IComponent {
            return Query.WithAll<T0, T1>(in systemContext.world, systemContext.dependsOn);
        }

        [INLINE(256)]
        public static QueryBuilderStatic WithAll<T0, T1>(in World world, JobHandle dependsOn) where T0 : unmanaged, IComponent where T1 : unmanaged, IComponent {
            return new QueryBuilderStatic(in world, dependsOn).WithAll<T0, T1>();
        }

        [INLINE(256)]
        public static QueryBuilderStatic WithAny<T0, T1>(in SystemContext systemContext) where T0 : unmanaged, IComponent where T1 : unmanaged, IComponent {
            return Query.WithAny<T0, T1>(in systemContext.world, systemContext.dependsOn);
        }

        [INLINE(256)]
        public static QueryBuilderStatic WithAny<T0, T1>(in World world, JobHandle dependsOn) where T0 : unmanaged, IComponent where T1 : unmanaged, IComponent {
            return new QueryBuilderStatic(in world, dependsOn).WithAny<T0, T1>();
        }

        [INLINE(256)]
        public static QueryBuilderStatic With<T>(in SystemContext systemContext) where T : unmanaged, IComponent {
            return Query.With<T>(in systemContext.world, systemContext.dependsOn);
        }

        [INLINE(256)]
        public static QueryBuilderStatic With<T>(in World world, JobHandle dependsOn) where T : unmanaged, IComponent {
            return new QueryBuilderStatic(in world, dependsOn).With<T>();
        }

        [INLINE(256)]
        public static QueryBuilderStatic Without<T>(in SystemContext systemContext) where T : unmanaged, IComponent {
            return Query.Without<T>(in systemContext.world, systemContext.dependsOn);
        }

        [INLINE(256)]
        public static QueryBuilderStatic Without<T>(in World world, JobHandle dependsOn) where T : unmanaged, IComponent {
