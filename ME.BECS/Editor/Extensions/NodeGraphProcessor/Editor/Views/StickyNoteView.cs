...
namespace ME.BECS.Extensions.GraphProcessor
{
    public class StickyNoteView : UnityEditor.Experimental.GraphView.StickyNote
	{
		...
		public void Initialize(BaseGraphView graphView, StickyNote note)
		{
            ...
            this.AddManipulator((IManipulator) new ContextualMenuManipulator(new System.Action<ContextualMenuPopulateEvent>(this.BuildContextualMenuCustom)));
		}

		private void BuildContextualMenuCustom(ContextualMenuPopulateEvent evt) {
			evt.menu.AppendAction("Delete", (d) => {
