...
namespace ME.BECS.Extensions.GraphProcessor
{
    ...
    public class ExposedParameterFieldFactory : IDisposable
    {
        ...
        public ExposedParameterFieldFactory(BaseGraph graph, scg::List<ExposedParameter> customParameters = null)
        {
            this.graph = graph;
        ...
        public void UpdateSerializedProperties(scg::List<ExposedParameter> parameters = null)
        {
            if (parameters != null)
